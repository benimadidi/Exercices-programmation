        ...
        <motion.div 
            ...
            className='container grid gap-14 lg:grid-cols-2'>
                ...
                <div className="flex flex-col justify-center md:py-12">
                    <motion.h1 variants={fadeInUp} className='text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl'>Découvrez la propriété de vos rêves avec Estatein</motion.h1>
                    <motion.p variants={fadeInUp} className='max-w-[640px] my-[16px_32px]'>
                    ...
                    <div className="flex gap-3.5 flex-wrap">
                        <motion.button variants={fadeInUp} className="primary-btn">En savoir plus</motion.button>
                        <motion.button variants={fadeInUp} className="secondary-btn">Parcourir les propriétés</motion.button>
                    </div>
                    ...
                    <div className="grid gap-3 mt-10 lg:mt-12 grid-cols-2 sm:grid-cols-3">
                        {heroStats.map((item) => (
                            //Carte
                            <motion.div variants={fadeInUp} key={item.id} className={`border border-gray-15 bg-gray-10 px-5 py-3.5 rounded-xl text-center lg:text-left ${item.id === 3 ? 'max-sm:col-span-2' : ''}`}>
